...
await conn.sendButton(m.chat, lenguajeGB.smsCont18Porn() + ` : *_${lenguajeGB['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}`, wm, url, [[lenguajeGB.smsSig(), `${usedPrefix + command}`], [`🥵 COSPLAY 🥵`, `${usedPrefix}cosplay`]], m)
}
