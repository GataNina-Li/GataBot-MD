...
const reply = await conn.reply(m.chat, '¡Imagen añadida exitosamente!\n\nResponde a este mensaje con "enviar" o "👍" sólo si deseas enviar los personajes a mis creadores para que lo agreguen en GataBot.', m).id
...
await conn.reply(m.chat, `*Solicitud de @${m.sender} Para agregar personajes de Fantasy RPG en GataBot*`, null, { mentions: [m.sender] })
