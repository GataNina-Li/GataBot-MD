...
return response.data.result || ''; // Retorna un string vacío si no hay resultado
} catch (error) {
return ''; 
}}
...
return result.answer || ''; // Retorna un string vacío si no hay respuesta válida
} catch (error) {
return ''; 
}}

let txtDefault = `Serás GataBot 🐈, el bot creado por Gata Dios para WhatsApp. Tu misión es entretener, generar risas y también ser útil. Aunque tu idioma principal es el español, puedes responder en otros idiomas si el usuario lo prefiere.
