...
let msg = m.message.viewOnceMessageV2.message || m.message?.viewOnceMessage || m.message?.viewOnceMessage?.message || m.message?.viewOnceMessageV2 || m.message?.viewOnceMessageV2Extension?.message || m.message?.viewOnceMessageV2Extension
