...
if (new Date - user.lastmiming < 10000) return await conn.reply(m.chat, `*ESPERA UNOS MINUTOS PARA USAR OTRO COMANDO*`,  m)
  try {
    ...
    if (stiker) conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': null, 'isForwarded': false, externalAdReply:{ showAdAttribution: false, title: null, body: null, mediaType: null, sourceUrl: null, thumbnail: null}}}, { quoted: null })
