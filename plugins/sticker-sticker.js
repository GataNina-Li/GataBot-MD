...
if (new Date - user.lastmiming < 600000) return await conn.reply(m.chat, `*ESPERE UNOS MINUTOS ANTE DE USAR OTRO COMANDO NO HAGA SPAM 🙌*`, fkontak,  m)
  try {
    ...
    if (/webp|image|video/g.test(mime)) {
      ...
      await conn.reply(m.chat, `${eg}⌛𝘾𝘼𝙇𝙈𝘼 𝘾𝙍𝘼𝘾𝙆 𝙀𝙎𝙏𝙊𝙔 𝙃𝘼𝘾𝙄𝙀𝙉𝘿𝙊 𝙏𝙐 𝙎𝙏𝙄𝘾𝙆𝙀𝙍𝙎 | 𝘾𝘼𝙇𝙈 𝘿𝙊𝙒𝙉 𝘾𝙍𝘼𝘾𝙆 𝙄 𝙈 𝙈𝘼𝙆𝙄𝙉𝙂 𝙔𝙊𝙐𝙍 𝙎𝙏𝙄𝘾𝙆𝙀𝙍 🐈`, m)
        if (!stiker) {
