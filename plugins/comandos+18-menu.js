...
let sections = Object.keys(temaX).map((v, index) => ({ title: `${wm[v]}`,
rows: [{ title: `🥵 ${temaX[index][1].toUpperCase()} 🥵`, description: `${0 + index}. ${temaX[index][0]}`, rowId: usedPrefix + temaX[index][0], }], }))
