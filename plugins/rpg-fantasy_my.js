...
await conn.sendMessage(m.chat, {image: { url: 'https://telegra.ph/file/77cd4b654273b5cde1ce8.jpg' }, caption: mensaje.trim(), mentions: conn.parseMention(mensaje) }, {quoted: fake })   
