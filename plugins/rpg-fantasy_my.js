...
await conn.sendMessage(m.chat, {video: { url: 'https://telegra.ph/file/c1d93544448619ffac87d.mp4' }, gifPlayback: true, caption: mensaje.trim(), mentions: conn.parseMention(mensaje) }, {quoted: fkontak })
