...
fake = {
contextInfo: {
externalAdReply: {title: 'Transfiera a otro Usuario 🧐', body: 'Algo no salió bien...', sourceUrl: accountsgb, thumbnailUrl: gataMenu}
}
}
...
return conn.reply(
m.chat,
`*Responda a un mensaje de @${m.quoted.sender.split('@')[0]} escribiendo el nombre o código del personaje*\n\n> *Para ver tus Personajes, escriba:*\n\`${usedPrefix}fantasymy o ${usedPrefix}fymy\``,
m,
