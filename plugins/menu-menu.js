...
let lvl = level
let emoji = numberToEmoji[level.toString()] || "❓"
...
⊜ *Tipo de registro »* ${user.registered === true ? `_${user.registroC === true ? 'Registro Completo 🗂️' : 'Registro Rápido 📑'}_` : '❌ _' + usedPrefix + 'Sin registro_'}
