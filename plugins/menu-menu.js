...
{ comando: (bot) => (bot.restrict ? 'off ' : 'on ') + 'restringir , restrict', descripcion: (bot) => bot.restrict ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled', contexto: 'Permisos para el Bot', showPrefix: true },
{ comando: (bot) => (bot.antiCall ? 'off ' : 'on ') + 'antillamar , anticall', descripcion: (bot) => bot.antiCall ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled', contexto: 'Evitar recibir llamadas en el Bot', showPrefix: true },
{ comando: (opts) => (global.opts['self'] ? 'on ' : 'off ') + 'publico , public', descripcion: (opts) => global.opts['self'] ? '❌' + 'Desactivado || Disabled' : '✅' + 'Activado || Activated', contexto: 'Permitir que todos usen el Bot', showPrefix: true },
...
{ comando: (opts) => (global.opts['autoread'] ? 'off ' : 'on ') + 'autovisto , autoread', descripcion: (opts) => global.opts['autoread'] ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled', contexto: 'Mensajes leídos automáticamente', showPrefix: true },
{ comando: (bot) => (bot.temporal ? 'off ' : 'on ') + 'temporal', descripcion: (bot) => bot.temporal ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled', contexto: 'Ingreso del Bot temporalmente en grupos', showPrefix: true },
{ comando: (chat) => (chat.stickers ? 'off ' : 'on ') + 'stickers', descripcion: (chat) => (chat.stickers ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled'), contexto: 'Stickers automáticos en chats', showPrefix: true }, 
...
{ comando: (chat) => (chat.modohorny ? 'off ' : 'on ') + 'modocaliente , modehorny', descripcion: (chat) => (chat.modohorny ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled'), contexto: 'Comandos con contenido para adultos', showPrefix: true }, 
...
{ comando: (chat) => (chat.antiver ? 'off ' : 'on ') + 'antiver , antiviewonce', descripcion: (chat) => (chat.antiver ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled'), contexto: ' No acultar mensajes de \"una sola vez\"', showPrefix: true }, 
]
