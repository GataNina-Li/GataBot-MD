...
{ comando: (chat) => (chat.stickers ? 'off ' : 'on ') + 'stickers', descripcion: () => (chat.stickers ? '✅ ' + 'Activado || Activated' : '❌ ' + 'Desactivado || Disabled'), contexto: 'Stickers automáticos en chats', showPrefix: true }, 
