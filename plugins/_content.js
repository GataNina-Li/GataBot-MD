...
// Cuentas
const response = await fetch('https://raw.githubusercontent.com/jackhokage/titanBot-MD/master/official_accounts.json')  
...
global.gataVidMenu = ['https://qu.ax/gKSQ.mp4', 'https://qu.ax/BBKU.mp4', 'https://qu.ax/DOPe.mp4'].getRandom()
...
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "5219992095470-1625305606@g.us" } : {}) }, message: { orderMessage: { itemCount : -999999, status: 1, surface : 1, message: 'Super Bot WhatsApp', orderTitle: 'Bang', thumbnail: gataMenu, sellerJid: '0@s.whatsapp.net' }}}
const estiloaudio = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "5219992095570-1625305606@g.us" } : {}) }, message: { "audioMessage": { "mimetype":"audio/ogg; codecs=opus", "seconds": "99569", "ptt": "true"   
}}} 
