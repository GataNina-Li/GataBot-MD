  ...
  if (option === 'privacy') {
    ...
    if (value === '1') {
      ...
      await conn.sendMessage(
        m.chat,
        {
          text: '✅ *Prestar bot activado.*\n> Los usuarios pueden usar el bot para unirlo a grupos.'
        },
        {quoted: m}
      )
    } else if (value === '0') {
      ...
      await conn.sendMessage(
        m.chat,
        {
          text: '✅ *Prestar bot desactivado.*\n> Los usuarios no podran unir el bot a grupos.'
        },
        {quoted: m}
      )
    } else {
