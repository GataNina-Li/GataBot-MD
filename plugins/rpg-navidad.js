...
const navidad2 = await res[Math.floor(res.length * Math.random())];
...
await conn.sendFile(m.chat, navidad2, 'navidad.jpg', `${text}\n${texto}` + `\n\n🎟️ 𝗣 𝗥 𝗘 𝗠 𝗜 𝗨 𝗠 ⇢ ${premium ? '✅' : '❌'}\n${wm}`, m, null, fake);
