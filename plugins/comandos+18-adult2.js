...
['boobs', 'tetas2'], ['hboobs', 'tetas3'], ['pussy', 'pussy'], ['paizuri', 'paizuri']]  
...
await conn.sendButton(m.chat, lenguajeGB.smsCont18PornP(), ` *_${lenguajeGB['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm, link, [[`🥵 BOOBS 🥵`, `${usedPrefix}tetas`], [lenguajeGB.smsSigPrem(), `${usedPrefix + command}`]], m, frep)}}
...
await conn.sendButton(m.chat, lenguajeGB.smsCont18PornP(), ` *_${lenguajeGB['smsBotonM7']()}_* » ${user.premiumTime > 0 ? '✅' : '❌'}\n` + wm, link, [[`🥵 BOOBS 2 🥵`, `${usedPrefix}tetas2`], [lenguajeGB.smsSigPrem(), `${usedPrefix + command}`]], m, frep)}}
...
handler.command = [temaX[0][1], temaX[1][1], temaX[2][1], temaX[3][1], temaX[4][1], temaX[4][1], temaX[5][1], temaX[6][1], temaX[7][1], temaX[8][1]]
