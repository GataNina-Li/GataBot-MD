...
try{const res = await fetch(`https://deliriusapi-official.vercel.app/download/ytmp4v2?url=${text}`);
...
const res = await fetch(`https://deliriusapi-official.vercel.app/download/ytmp4v2?url=${text}`);
const json = await res.json();
...
const tiny = await axios.get(`https://deliriusapi-official.vercel.app/download/ytmp4v2?url=${resultFix[0].audio}`);
...
const tiny = await axios.get(`https://deliriusapi-official.vercel.app/download/ytmp4v2?url=${resultFix[0].video}`);
const tinyUrl = tiny.data;
const title = getUrl.videoDetails.title;
const thumb = getUrl.player_response.microformat.playerMicroformatRenderer.thumbnail.thumbnails[0].url;
