...
let msg = m.reply.message.extendedTextMessage?.contextInfo?.quotedMessage.stickerMessage //|| m.message.extendedTextMessage?.contextInfo.quotedMessage.stickerMessage
let type = Object.keys(msg)[0]
media = await downloadContentFromMessage(msg[type], 'image')
buffer = Buffer.from([])
