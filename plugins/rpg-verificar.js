...
//await conn.sendEvent(m.chat, gt + " - Segunda lista de pasatiempos.", `*Para ver las idicaciones para seleccionar pasatiempos, dirígete al primer mensaje del evento*\n\n_Si quieres que este un pasatiempo que no forma parte de esta lista contacta con los creadores de este bot._`, "Toca para ver más\n" + yyr2 + "\n\nPara ver más pasatiempos revise los otros mensajes del bot.", false)
//await conn.sendEvent(m.chat, gt + " - Tercera lista de pasatiempos.", `*Para ver las idicaciones para seleccionar pasatiempos, dirígete al primer mensaje del evento*\n\n_Si quieres que este un pasatiempo que no forma parte de esta lista contacta con los creadores de este bot._`, "Toca para ver más\n" + yyr3 + "\n\nPara ver más pasatiempos revise los otros mensajes del bot.", false)
//await conn.sendEvent(m.chat, gt + " - Última lista de pasatiempos.\n\nSi quieres omitir agregar pasatiempos usa el comando #finalizar pero ten en cuenta que no recibirás recompensas ni tiempo premium gratis.", `*Para ver las idicaciones para seleccionar pasatiempos, dirígete al primer mensaje del evento*\n\n_Si quieres que este un pasatiempo que no forma parte de esta lista contacta con los creadores de este bot._`, "Toca para ver más\n" + yyr4 + "\n\nMás pasatiempos próximamente...", false)
}}
