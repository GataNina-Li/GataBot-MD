...
const { DisconnectReason, useMultiFileAuthState, MessageRetryMap, fetchLatestBaileysVersion, makeCacheableSignalKeyStore, jidNormalizedUser, PHONENUMBER_MCC } = import('@whiskeysockets/baileys')
const { CONNECTING } = ws
const { chain } = lodash
