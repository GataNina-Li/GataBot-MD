...
const smsLista1 = () => { return `🌟 INFORMACIÓN DE BOT 🌟`}
...
//_allantilink.js
const smsTextoYT = () => { return '🐲 𝗦𝘂𝗽𝗲𝗿 𝗕𝗼𝘁-𝗠𝗗 - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
...
const eGataCoins = () => { return '☣️ ZCoins' }
const eGataTickers = () => { return '🎫 Z Tickets' } 
...
const smsContacto4 = () => { return 'Contacto Oficial de Bot 🐲'}
