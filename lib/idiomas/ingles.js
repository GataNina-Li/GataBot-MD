...
const smsPremium = () => { return `${global.lenguajeGB['smsAvisoAG']()}\`\`\`¡¡THIS COMMAND IS ONLY AVAILABLE TO PREMIUM USERS AND MY CREATOR!! TO GET PREMIUM BUY A PASS USING #pass premium\`\`\`` }//PREMIUM USERS
