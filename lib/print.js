...
if (line.trim().startsWith('>') && (index === 0 || !lines[index - 1].trim().startsWith('>'))) {
formattedLine = chalk.bgGray.dim(line.replace(/^>/, '┃'));
}
formattedLine = formattedLine.replace(mdRegex, mdFormat(4))
