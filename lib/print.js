...
let formatted = !types[type] || depth < 1 ? text : 
                (text.includes('`') ? 
                    (types[type] ? chalk.bgGray.white(chalk[types[type]](text.replace(mdRegex, (match, p1, p2, p3) => p3 ? mdFormat(depth - 1)(match, null, null, p3) : match))) : 
                                    chalk.bgGray.white(text.replace(mdRegex, (match, p1, p2, p3) => p3 ? mdFormat(depth - 1)(match, null, null, p3) : match))) : 
