...
await formatMessageTypes(m.mtype) //m.mtype ? m.mtype : 'No especificado'  //? m.mtype.replace(/message$/i, '').replace('audio', m.msg.ptt ? 'PTT' : 'audio').replace(/^./, v => v.toUpperCase()) : ''
)
...
default:
return global.mid.idioma_code === 'es' ? messageStubType || 'No especificado' : await formaTxt(messageStubType) || 'Not specified'
}}
