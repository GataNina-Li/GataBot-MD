...
console.log(`
${chalk[getRandomColor()]('╭━━━━━━━━━━━━━━')}
${chalk[getRandomColor()]('┃ ❖')} ${chalk.white.bold('Bot:')} ${chalk.cyan.bold('%s')} 
${chalk[getRandomColor()]('┃ ❖')} ${chalk.white.bold('Horario:')} ${chalk.black.bgGreen('%s')}
${chalk[getRandomColor()]('┃ ❖')} ${chalk.white.bold('Acción:')} ${formatMessageStubType(m.messageStubType, name_user)}
${chalk[getRandomColor()]('┃ ❖')} ${chalk.white.bold('Usuario:')} ${chalk.white('%s')} | ${chalk.yellow('%s%s')}
${chalk[getRandomColor()]('┃ ❖')} ${chalk.magenta('%s')}
${chalk[getRandomColor()]('┃ ❖')} ${chalk.white.bold('Peso del mensaje:')} ${chalk.red('%s [%s %sB]')}
${chalk[getRandomColor()]('┃ ❖')} ${chalk.white.bold('Tipo de mensaje:')} ${chalk.black(chalk.red('%s'))}
${chalk[getRandomColor()]('╰━━━━━━━━━━━━━━')}`.trim(),
...
//╰────────────✦`.trim(),            
//me + ' | ~' + conn.user.name == undefined ? conn.getName(conn.user.jid) : conn.user.name + `${conn.user.jid == global.conn.user.jid ? '' : ' 【𝗚𝗕 - 𝗦𝗨𝗕 𝗕𝗢𝗧】'}`,
me + ' | ~' + conn.user.name + `${conn.user.jid == global.conn.user.jid ? 'Principal' : ' 【𝗚𝗕 - 𝗦𝗨𝗕 𝗕𝗢𝗧】'}`,
