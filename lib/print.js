...
let mdFormat = (depth = 4) => (_, type, text1, text2, quoted) => {
    ...
    let formattedText = text1 || text2 || quoted;
    if (quoted !== undefined && text1 && text2) {
        formattedText = chalk.bgGray.white.bold(quoted);
    } else if (quoted !== undefined && text1) {
        formattedText = chalk.bgGray.white.italic(quoted);
    } else if (quoted !== undefined && text2) {
        formattedText = chalk.bgGray.white.bold(quoted);
    } else if (quoted !== undefined) {
        formattedText = chalk.bgGray.white(quoted);
    } else if (types[type]) {
        formattedText = chalk[types[type]](formattedText);
    }
