...
┃ ❖ Horario: ${chalk.black.bgGreen('%s')}
┃ ❖ Acción: ${formatMessageStubType(m.messageStubType, name_user)}
┃ ❖ Usuario: ${chalk.white('%s')} | ${chalk.yellow('%s%s')}
┃ ❖ ${chalk.magenta('%s')}
┃ ❖ Peso del mensaje: ${chalk.red('%s [%s %sB]')}
┃ ❖ Tipo de mensaje: ${chalk.black(chalk.red('%s'))}
╰━━━━━━━━━━━━━━`.trim(),
