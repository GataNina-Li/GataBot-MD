...
console.log(`
${chalk.colors('╭━━━━━━━━━━━━━━')}
${chalk.colors('┃ ❖')} Bot: ${chalk.cyan.bold('%s')} 
${chalk.colors('┃ ❖')} Horario: ${chalk.black.bgGreen('%s')}
${chalk.colors('┃ ❖')} Acción: ${formatMessageStubType(m.messageStubType, name_user)}
${chalk.colors('┃ ❖')} Usuario: ${chalk.white('%s')} | ${chalk.yellow('%s%s')}
${chalk.colors('┃ ❖')} ${chalk.magenta('%s')}
${chalk.colors('┃ ❖')} Peso del mensaje: ${chalk.red('%s [%s %sB]')}
${chalk.colors('┃ ❖')} Tipo de mensaje: ${chalk.black(chalk.red('%s'))}
${chalk.colors('╰━━━━━━━━━━━━━━')}`.trim(),
