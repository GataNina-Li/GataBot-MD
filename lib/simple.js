...
const mentionedJid = Array.isArray(quoted) ? quoted : [quoted]
return Buffer.isBuffer(text) ? conn.sendFile(jid, text, 'file', '', quoted, false, options) : conn.sendMessage(jid, { ...options, text }, { quoted, ...options }) //conn.sendMessage(jid, { ...options, text, contextInfo: { mentionedJid: [quoted], forwardedNewsletterMessageInfo: { newsletterJid: randomChannel.id, serverMessageId: '', newsletterName: randomChannel.nombre }, forwardingScore: 1, isForwarded: true, ...options }}/*, { quoted, ...options })
} */
async function value(jid, text = '', quoted, options) {
if (Buffer.isBuffer(text)) {
return conn.sendFile(jid, text, 'file', '', quoted, false, options)
} else {
const contextInfo = {
mentionedJid: Array.isArray(quoted) ? quoted : [quoted],
isForwarded: true,
forwardingScore: 1, 
