...
sendGroupV4Invite: {
  ...
  const sections = [
    {
      title: lister[6][0], // Título de la lista
      rows: lister[6][1].map(item => ({
        header: item[0], // Header de la fila
        title: item[1], // Título de la fila
        description: item[2], // Descripción de la fila
        id: item[3] // ID de la fila
      }))
    }
  ];
