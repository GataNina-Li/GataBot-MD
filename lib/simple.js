            ...
            if (/^https?:\/\//i.test(buffer)) {
              try {
                ...
                if (/^image\//i.test(contentType)) {
                  ...
                  console.error("Tipo MIME incompatible:", contentType);
                }
              } catch (error) {
                console.error("No se pudo obtener el tipo MIME:", error);
              }
            } else {
              try {
                ...
                console.error("No se pudo obtener el tipo de archivo:", error);
              }
            }
...
/*list?.forEach(lister => {
  ...
  // Iterar sobre cada sección de la lista
  for (let i = 1; i < lister.length; i++) {
    let section = lister[i];
    sections.push({
      title: section[0],  
      rows: section[1].map(item => ({
        header: item[0],   
        title: item[1],    
        description: item[2], 
        id: item[3]       
