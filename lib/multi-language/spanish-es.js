let mAdvertencia = '> ⚠️ *`ADVERTENCIA 𓃠`*\n\n',
let mInfo = '> 📢 *`INFORMACIÓN 𓃠`*\n\n',
let mExito = '> ✅ *`ÉXITO 𓃠`*\n\n',
let mError = '> ❌ *`ERROR 𓃠`*\n\n',
...
//_allantilink.js
mTiktok: mAdvertencia + '*¡No se permite enlace de TikTok!*\n*Procedo a eliminarte*',
mYoutube: mAdvertencia + '*¡No se permite enlace de YouTube!*\n*Procedo a eliminarte*',
mTelegram: mAdvertencia + '*¡No se permite enlace de Telegram!*\n*Procedo a eliminarte*',
mFacebook: mAdvertencia + '*¡No se permite enlace de Facebook!*\n*Procedo a eliminarte*',
mInstagram: mAdvertencia + '*¡No se permite enlace de Instagram!*\n*Procedo a eliminarte*',
mX: mAdvertencia + '*¡No se permite enlace de X (Twitter)!*\n*Procedo a eliminarte*',
