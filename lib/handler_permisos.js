const botPermisos = (plugin, conn, _user, noPrefix, m, isROwner, isOwner, isAdmin, isBotAdmin, isMods, isPrems, fail, _prefix) => {
let hl = _prefix 
let adminMode = global.db.data.chats[m.chat].modoadmin
let gata = `${global.plugins.botAdmin || global.plugins.admin || global.plugins.group || global.plugins || noPrefix || hl ||  m.text.slice(0, 1) == hl || global.plugins.command}`
