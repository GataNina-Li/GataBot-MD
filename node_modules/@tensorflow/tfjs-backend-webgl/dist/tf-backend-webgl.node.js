...
function getTextureShapeFromLogicalShape(logShape, isPacked) {
    ...
    var isLongNarrowTex = textureShape != null &&
        Math.max.apply(Math, __spread(textureShape)) > maxSizeForNarrowTex &&
        Math.min.apply(Math, __spread(textureShape)) <= (isPacked ? 2 : 1) &&
        Math.min.apply(Math, __spread(textureShape)) > 0;
