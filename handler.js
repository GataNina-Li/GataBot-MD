...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: wm, body: '😻 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 😻', thumbnail: imagen2, sourceUrl: [md, yt, ig, paypal].getRandom() }}}}, tg)
