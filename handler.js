...
let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: wm, body: '😻 𝗦𝘂𝗽𝗲𝗿 ' + gt + ' 😻', thumbnail: await fetch(gataMenu.getRandom()), sourceUrl: redesMenu.getRandom() }}}}, tg)
